...
const Hero = () => {
  ...
  return (
    <Section className='hidden sm:flex h-full w-full bg-black'>
      <Container className='hidden sm:flex'>
        <ColumnLeft className='h-full'>
          <motion.h1
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.p className='hidden sm:flex'
            variants={fadeLeft}
            initial='hidden'
            animate='visible'
            transition={{ duration: 1 }}
          ...
          <Link
          className='bg-red-600 h-12 w-28 font-semibold rounded text-center items-center pt-2'
          to="/home"
